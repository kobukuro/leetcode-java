...
public class CoinChange322Test {
    ...
    void testCoinChangeMemoization_Example1() {
        ...
        int result = assertTimeoutPreemptively(Duration.ofMillis(100), () -> solution.coinChangeMemoization(coins, amount));
    ...
    void testCoinChangeTabulation_Example1() {
        ...
        int result = assertTimeoutPreemptively(Duration.ofMillis(100), () -> solution.coinChangeTabulation(coins, amount));
