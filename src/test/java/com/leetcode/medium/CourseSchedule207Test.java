...
public class CourseSchedule207Test {
    private CourseSchedule207 solution;

    @BeforeEach
    void setUp() {
        solution = new CourseSchedule207();
    }
    ...
    void testCanFinish_Example1() {
        ...
        boolean result = assertTimeoutPreemptively(Duration.ofMillis(100), () -> solution.canFinish(numCourses, prerequisites));
    ...
    @Test
    void testCanFinish_Example3() {
        int numCourses = 100;
        int[][] prerequisites = {{1, 0}, {2, 0}, {2, 1}, {3, 1}, {3, 2}, {4, 2}, {4, 3}, {5, 3}, {5, 4}, {6, 4}, {6, 5}, {7, 5}, {7, 6},
